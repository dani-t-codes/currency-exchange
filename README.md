...
- Once you have Git installed on your computer, go to this (GitHub repository)[https://github.com/dani-t-codes/super-galactic], click the "Fork" button in the upper right hand corner of the page, and clone this application with the following command:`git clone https://github.com/dani-t-codes/super-galactic`.
...
* From there, you can run `npm run test` to run the package's test script(s).
* If you run `npm run start`, you will then be able to open a live session of the application.
